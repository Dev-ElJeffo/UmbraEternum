...
exports.mockPool = exports.mockCharacters = exports.mockUsers = void 0;
...
exports.mockPool = {
    query: globals_1.jest.fn((sql, params) => {
        ...
        return new Promise((resolve) => {
            ...
            if (sql.match(/^SELECT/i)) {
                if (sql.match(/FROM users/i)) {
                    ...
                    let characters = [...exports.mockCharacters];
                    // Filtrar por ID se especificado
            ...
            // INSERT query
                ...
                if (sql.match(/INTO users/i)) {
                    ...
                    const newCharacter = {
                        id: exports.mockCharacters.length + 1,
                        user_id: params?.[0] || 1,
                    ...
                    exports.mockCharacters.push(newCharacter);
            ...
            // UPDATE query
                ...
                if (sql.match(/users/i)) {
                    ...
                    const userIndex = exports.mockUsers.findIndex(user => user.id === userId);
                    if (userIndex !== -1) {
                        // Update role
                        if (sql.match(/SET role = \?/i)) {
                            exports.mockUsers[userIndex].role = params?.[0];
                        }
                        // Soft delete
                        else if (sql.match(/SET active = false/i)) {
                            exports.mockUsers[userIndex].active = false;
                        }
                        exports.mockUsers[userIndex].updated_at = new Date().toISOString();
                    ...
                    const charIndex = exports.mockCharacters.findIndex(char => char.id === charId);
                    if (charIndex !== -1) {
                        // Update character properties
                        if (sql.match(/SET name = \?, class = \?, level = \?/i)) {
                            exports.mockCharacters[charIndex].name = params?.[0];
                            exports.mockCharacters[charIndex].class = params?.[1];
                            exports.mockCharacters[charIndex].level = params?.[2];
                        }
                        // Soft delete
                        else if (sql.match(/SET active = false/i)) {
                            exports.mockCharacters[charIndex].active = false;
                        }
                        exports.mockCharacters[charIndex].updated_at = new Date().toISOString();
                        resolve({ affectedRows: 1, changedRows: 1 });
                    }
                    else {
                        resolve({ affectedRows: 0, changedRows: 0 });
            ...
            // DELETE query
                ...
                if (sql.match(/FROM characters/i)) {
                    if (sql.match(/WHERE user_id = \?/i)) {
                        ...
                        const initialLength = exports.mockCharacters.length;
                        const charactersToRemove = exports.mockCharacters.filter(char => char.user_id === userId).length;
                        // Filtrar personagens por user_id usando o splice ou filter
                        for (let i = exports.mockCharacters.length - 1; i >= 0; i--) {
                            if (exports.mockCharacters[i].user_id === userId) {
                                exports.mockCharacters.splice(i, 1);
                            }
                        }
                        ...
                        for (let i = exports.mockCharacters.length - 1; i >= 0; i--) {
                            if (exports.mockCharacters[i].id === charId) {
                                exports.mockCharacters.splice(i, 1);
                            }
                        }
                        resolve({ affectedRows: initialLength - exports.mockCharacters.length });
                    }
                }
            }
            // Default fallback
    ...
    getConnection: globals_1.jest.fn(() => ({
        beginTransaction: globals_1.jest.fn(() => Promise.resolve()),
        commit: globals_1.jest.fn(() => Promise.resolve()),
        rollback: globals_1.jest.fn(() => Promise.resolve()),
        release: globals_1.jest.fn(),
        query: globals_1.jest.fn((sql, params) => exports.mockPool.query(sql, params))
    })),
